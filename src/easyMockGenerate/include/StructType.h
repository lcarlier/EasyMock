...
public:
   ...
   *
   * \param p_name See ::StructType::StructType(const std::string p_name,bool p_is_embedded_in_other_type).
   * \param p_type_def_name See ::StructType::StructType(const std::string p_name, const std::string p_type_def_name, bool p_is_embedded_in_other_type).
   * \param p_elem See ::StructType::StructType(const std::string p_name, const ComposableFieldItf::Vector p_elem, bool p_is_embedded_in_other_type).
   * \param p_is_embedded_in_other_type See ::StructType::StructType(const std::string p_name,bool p_is_embedded_in_other_type).
   */
